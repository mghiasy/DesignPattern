...
public class AccountentryAdapter {
    public static AccountEntryDTO getAccountEntryDto(AccountEntry accountEntry){
        AccountEntryDTO accountEntryDTO= new AccountEntryDTO(accountEntry.getDate(), accountEntry.getAmount(), accountEntry.getDescription(), accountEntry.getFromAccountNumber(), accountEntry.getFromPersonName());
